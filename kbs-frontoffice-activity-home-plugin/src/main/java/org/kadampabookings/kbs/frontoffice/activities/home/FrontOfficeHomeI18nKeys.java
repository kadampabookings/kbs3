...
public interface FrontOfficeHomeI18nKeys {
    ...
    String PodcastsCard3Title = "PodcastsCard3Title";
    String PodcastsCard6Title = "PodcastsCard6Title";
    String MoreEvents = "MoreEvents";
    String PodcastsHeader = "PodcastsHeader";
    String AttendInPerson = "AttendInPerson";
    String AttendOnline = "AttendOnline";
    ...
    String OnlineBookingsOpenLater = "OnlineBookingsOpenLater";
