...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.ast.formatter.spi.AstFormatterProvider": return new ServiceLoader<S>(dev.webfx.platform.ast.json.JsonFormatterProvider::new, dev.webfx.platform.ast.yaml.formatter.YamlFormatterProvider::new);
            ...
            case "dev.webfx.platform.ast.parser.spi.AstParserProvider": return new ServiceLoader<S>(dev.webfx.platform.ast.json.JsonAstParserProvider::new, dev.webfx.platform.ast.yaml.parser.YamlParserProvider::new);
