...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.ast.spi.formatter.AstFormatterProvider": return new ServiceLoader<S>(dev.webfx.platform.ast.json.formatter.JsonFormatterProvider::new, dev.webfx.platform.ast.yaml.formatter.YamlFormatterProvider::new);
            case "dev.webfx.platform.ast.spi.parser.AstParserProvider": return new ServiceLoader<S>(dev.webfx.platform.ast.json.parser.JsonParserProvider::new, dev.webfx.platform.ast.yaml.parser.YamlParserProvider::new);
            ...
            case "dev.webfx.platform.boot.spi.ApplicationJob": return new ServiceLoader<S>(one.modality.base.client.entities.util.functions.ClientFunctionsRegisteringApplicationJob::new, one.modality.crm.client.profile.ModalityClientProfileInitJob::new);
            ...
            case "dev.webfx.platform.resource.spi.impl.gwt.GwtResourceBundle": return new ServiceLoader<S>(kbs.frontoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
