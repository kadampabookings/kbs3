...
public interface GwtEmbedResourcesBundle extends ClientBundle {
    ...
    final class ProvidedGwtResourceBundle extends WebResourceBundleBase {
        public ProvidedGwtResourceBundle() {
            ...
            registerResource("dev/webfx/extras/i18n/en.properties", () -> R.r2().getText());
            ...
            registerResource("dev/webfx/extras/player/video/web/videojs/videojs.js", () -> R.r8().getText());
            registerResource("dev/webfx/extras/webview/pane/WebViewPane.js", () -> R.r9().getText());
            registerResource("dev/webfx/platform/conf/src-root.properties", () -> R.r10().getText());
            registerResource("dev/webfx/platform/meta/exe/exe.properties", () -> R.r11().getText());
