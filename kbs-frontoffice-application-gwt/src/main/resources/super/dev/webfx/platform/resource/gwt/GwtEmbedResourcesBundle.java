...
public interface GwtEmbedResourcesBundle extends ClientBundle {
    ...
    final class ProvidedGwtResourceBundle extends GwtResourceBundleBase {
        public ProvidedGwtResourceBundle() {
            registerResource("dev/webfx/extras/player/video/web/videojs/videojs.js", R.r1());
            registerResource("dev/webfx/extras/webview/pane/WebViewPane.js", R.r2());
            registerResource("dev/webfx/platform/conf/src-root.properties", R.r3());
            registerResource("dev/webfx/platform/meta/exe/exe.properties", R.r4());
            registerResource("dev/webfx/stack/i18n/de.properties", R.r5());
            registerResource("dev/webfx/stack/i18n/en.json", R.r6());
