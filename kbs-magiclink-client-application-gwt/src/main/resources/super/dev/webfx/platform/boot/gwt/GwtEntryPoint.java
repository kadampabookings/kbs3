...
public final class GwtEntryPoint implements ApplicationBooterProvider, EntryPoint {
    ...
    public static void registerServiceProviders() {
        ...
        register(dev.webfx.platform.boot.spi.ApplicationJob.class, dev.webfx.stack.orm.dql.query.interceptor.DqlQueryInterceptorInitializer::new, dev.webfx.stack.orm.dql.submit.interceptor.DqlSubmitInterceptorInitializer::new);
        ...
        register(dev.webfx.stack.com.bus.call.spi.BusCallEndpoint.class, dev.webfx.stack.authn.buscall.AuthenticateMethodEndpoint::new, dev.webfx.stack.authn.buscall.GetUserClaimsMethodEndpoint::new, dev.webfx.stack.authn.buscall.LogoutMethodEndpoint::new, dev.webfx.stack.authn.buscall.UpdateCredentialsMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryBatchMethodEndpoint::new, dev.webfx.stack.db.query.buscall.ExecuteQueryMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitBatchMethodEndpoint::new, dev.webfx.stack.db.submit.buscall.ExecuteSubmitMethodEndpoint::new);
        ...
        register(dev.webfx.stack.com.serial.spi.SerialCodec.class, dev.webfx.stack.authn.serial.MagicLinkCredentialsSerialCodec::new, dev.webfx.stack.authn.serial.MagicLinkPasswordUpdateSerialCodec::new, dev.webfx.stack.authn.serial.MagicLinkRenewalRequestSerialCodec::new, dev.webfx.stack.authn.serial.MagicLinkRequestSerialCodec::new, dev.webfx.stack.authn.serial.PasswordUpdateSerialCodec::new, dev.webfx.stack.authn.serial.UserClaimsSerialCodec::new, dev.webfx.stack.authn.serial.UsernamePasswordCredentialsSerialCodec::new, dev.webfx.stack.com.bus.call.BusCallArgument.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.BusCallResult.ProvidedSerialCodec::new, dev.webfx.stack.com.bus.call.SerializableAsyncResult.ProvidedSerialCodec::new, dev.webfx.stack.com.serial.spi.impl.ProvidedBatchSerialCodec::new, dev.webfx.stack.db.datascope.aggregate.AggregateScope.ProvidedSerialCodec::new, dev.webfx.stack.db.query.buscall.serial.PairSerialCodec::new, dev.webfx.stack.db.query.buscall.serial.QueryArgumentSerialCodec::new, dev.webfx.stack.db.query.buscall.serial.QueryResultSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.GeneratedKeyReferenceSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.SubmitArgumentSerialCodec::new, dev.webfx.stack.db.submit.buscall.serial.SubmitResultSerialCodec::new);
