...
public final class PodcastsActivity extends ViewDomainActivityBase implements OperationActionFactoryMixin, ModalityButtonFactoryMixin {
    ...
    public Node buildUi() {
        ...
        VBox.setMargin(podcastsLabel, new Insets(50, 0, 50, 0));
        ...
        EntityStore.create(DataSourceModelService.getDefaultDataSourceModel())
                ...
                .onSuccess(teachers -> Platform.runLater(() -> {
                    TabsBar<Teacher> tabsBar = new TabsBar<>(PodcastsActivity.this, teacherProperty::set);
    ...
    protected void startLogic() {
        ReactiveObjectsMapper.<Podcast, Node>createPushReactiveChain(this)
                ...
                .setIndividualEntityToObjectMapperFactory(IndividualEntityToObjectMapper.createFactory(PodcastsView::new, PodcastsView::setPodcast, PodcastsView::getView))
