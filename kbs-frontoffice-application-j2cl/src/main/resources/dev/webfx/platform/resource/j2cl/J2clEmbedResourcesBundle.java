...
public interface J2clEmbedResourcesBundle extends ClientBundle {
    ...
    final class ProvidedJ2clResourceBundle extends J2clResourceBundleBase {
        public ProvidedJ2clResourceBundle() {
            registerResource("dev/webfx/extras/player/video/web/videojs/videojs.js", () -> R.r1().getText());
            registerResource("dev/webfx/extras/webview/pane/WebViewPane.js", () -> R.r2().getText());
            registerResource("dev/webfx/platform/conf/src-root.properties", () -> R.r3().getText());
            registerResource("dev/webfx/platform/meta/exe/exe.properties", () -> R.r4().getText());
