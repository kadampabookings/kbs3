...
public interface J2clEmbedResourcesBundle extends ClientBundle {
    ...
    final class ProvidedJ2clResourceBundle extends J2clResourceBundleBase {
        public ProvidedJ2clResourceBundle() {
            ...
            registerResource("dev/webfx/stack/i18n/de.properties", () -> R.r4().getText());
            registerResource("dev/webfx/stack/i18n/en.json", () -> R.r5().getText());
            registerResource("dev/webfx/stack/i18n/es.properties", () -> R.r6().getText());
            ...
            registerResource("dev/webfx/stack/i18n/vi.properties", () -> R.r9().getText());
            registerResource("dev/webfx/stack/i18n/zh.properties", () -> R.r10().getText());
